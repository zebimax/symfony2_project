...
use AppBundle\EventListener\TwigSubscriber;
...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2015-03-30 at 16:30:38.
 */
class TwigSubscriberTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var TwigSubscriber
     */
    ...
    protected function setUp()
    {
        ...
        $this->object = new TwigSubscriber($this->twigEnvironmentMock, $this->tokenStorage);
    }
    ...
    /**
     * @covers AppBundle\EventListener\TwigSubscriber::getSubscribedEvents
     */
    public function testGetSubscribedEvents()
    {
        $this->assertSame(
            [KernelEvents::REQUEST => ['onKernelRequest', TwigSubscriber::EVENT_PRIORITY]],
            $this->object->getSubscribedEvents()
        );
    }

    /**
     * @covers AppBundle\EventListener\TwigSubscriber::onKernelRequest
     */
