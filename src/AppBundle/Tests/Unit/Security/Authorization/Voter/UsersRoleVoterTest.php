...
use AppBundle\Security\Authorization\Voter\UsersRoleVoter;
use AppBundle\Entity\Role;
use Symfony\Component\Security\Core\Authorization\Voter\VoterInterface;

class UsersRoleVoterTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var UsersRoleVoter
     */
     ...
     * @var array
     */
    protected $supportedAttributes = [UsersRoleVoter::USERS, UsersRoleVoter::USERS_LIST, UsersRoleVoter::USERS_ADD];
     ...
     * @covers AppBundle\Security\Authorization\Voter\UsersRoleVoter::vote
     */
    ...
    public function voteDataProvider()
    {
        ...
        foreach ($this->supportedAttributes as $attribute) {
            ...
            $data[$attribute.' access denied manager'] = [
